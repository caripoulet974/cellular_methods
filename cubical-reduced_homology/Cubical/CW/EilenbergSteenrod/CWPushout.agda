...
module Cubical.CW.EilenbergSteenrod.CWPushout where
...
finSplit3 n m l x = Iso.fun (⊎Iso {A = Fin (n +ℕ m)}{C = (Fin n) ⊎ (Fin m)}{B = Fin l}{D = Fin l} (invIso (Iso-Fin⊎Fin-Fin+ {n}{m})) idIso)
                            (Iso.inv (Iso-Fin⊎Fin-Fin+ {n +ℕ m}{l}) x)
